...
describe('HTTPTransport', () => {
	...
	const OriginalFormData = (globalThis as unknown as { FormData?: unknown })
		.FormData

	beforeEach(() => {
		;(globalThis as unknown as { XMLHttpRequest: unknown }).XMLHttpRequest =
			FakeXMLHttpRequest as unknown
		;(globalThis as unknown as { FormData: unknown }).FormData =
			FakeFormData as unknown
		FakeXMLHttpRequest.last = null
	})

	afterEach(() => {
		;(globalThis as unknown as { XMLHttpRequest: unknown }).XMLHttpRequest =
			OriginalXHR as unknown
		if (OriginalFormData) {
			;(globalThis as unknown as { FormData: unknown }).FormData =
				OriginalFormData
		}
